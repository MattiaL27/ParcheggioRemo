...
public class ParkingMap implements IParkingMap {
     ...
     *
     * @param vehicle
     * @throws CantWayInException se il veichle ha valore null, se il veichle è già inserito in actualVehicles,
     ...
     *
     * @param vehicle
     * @throws CantWayOutException se il veichle ha valore null, se il veichle non esiste in actualVehicles.
     */
    @Override
